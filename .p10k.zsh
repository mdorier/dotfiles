# Generated by Powerlevel10k configuration wizard on 2020-12-05 at 18:29 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # wifi                  # wifi speed
    spack                   # example user-defined segment (see prompt_example function below)
  )
  ...
  typeset -g POWERLEVEL9K_SPACK_SHOW_ENV=true
